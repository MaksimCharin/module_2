...
Разработка функционала банковского приложения в ЛК клиента. Добавлена возможность полноценного взаимодействия
с программой.
...
9. В стартовой точке проекта, модуле *main.py* реализована работа приложения. Для запуска, необходимо выполнить внутри
модуля, код.
```
if __name__ == "__main__":
    main()
...
```
## Пример работы теста
Обновлен ряд тестов в исполняемых модулях. Покрытие тестами - 89%
