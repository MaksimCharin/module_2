...
def test_get_mask_card_number(valid_card_number_list):
    for crd_number, mask_value in valid_card_number_list:
        assert get_mask_card_number(crd_number) == mask_value


def test_get_mask_card_number_exceptions(invalid_card_number_list):
...
def test_get_mask_account(valid_acc_number_list):
    for acc_number, mask_value in valid_acc_number_list:
        assert get_mask_account(acc_number) == mask_value


def test_get_mask_acc_number_exceptions(invalid_acc_number_list):
